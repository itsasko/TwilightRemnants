...
void AEnemy::CheckPatrolTarget()
{
	if (InTargetRange(PatrolTarget, PatrolRadius))
	{
		...
		GetWorldTimerManager().SetTimer(PatrolTimer, this, &AEnemy::PatrolTimerFinished, PatrolWaitMax);
	}
}
...
void AEnemy::SpawnDefaultWeapon()
{
	...
	if (GetMesh()->DoesSocketExist(FName("WeaponSocket_Second")))
	{
		AWeapon* SecondaryWeapon = World->SpawnActor<AWeapon>(WeaponClass);
		SecondaryWeapon->Equip(GetMesh(), FName("WeaponSocket_Second"), this, this);
		SecondaryEquippedWeapon = SecondaryWeapon;
	}
}
