...
void ASlashCharacter::GetHit_Implementation(const FVector& ImpactPoint, AActor* Hitter)
{
	...
	if (IsAlive())
	{
		...
		if (AnimInstance && GetHitReactMontage())
		{
			...
			AnimInstance->Montage_SetEndDelegate(EndDelegate, GetHitReactMontage());
		}
	}
	else Die();
}
...
void ASlashCharacter::AddHealth(AHealthKit* HealthKit)
{
	if (Attributes && SlashOverlay)
	{
		Attributes->AddHealth(HealthKit->GetHealth());
...
void ASlashCharacter::Attack()
{
	...
	if (CanAttack())
	{
		if (CharacterState == ECharacterState::ESC_EquippedTwoHandedWeapon)
		{
...
{
	if (Weapon->Tags.Contains(FName("TwoHanded")))
	{
		Weapon->Equip(GetMesh(), FName("hand_rSocket"), this, this, FName("hand_lSocket"));
...
void ASlashCharacter::Arm()
{
	...
	if (EquippedWeapon->Tags.Contains(FName("TwoHanded")))
	{
		CharacterState = ECharacterState::ESC_EquippedTwoHandedWeapon;
	}
	else CharacterState = ECharacterState::ECS_EquippedOneHandedWeapon;
	ActionState = EActionState::EAS_EquippingWeapon;
}
